...
import random, sys, webbrowser, copy, pygame, Constants, Mouse
...
def setup():
    ...
    COLORSCHEMES = (((150, 200, 255), RED, GREEN, BLUE, YELLOW, ORANGE, PURPLE),
                    ...
                    ((195, 179, 0), (255, 239, 115), (255, 226, 0), (147, 3, 167), (24, 38, 176), (166, 147, 0),
                     (197, 97, 211)),
                    ((85, 0, 0), (155, 39, 102), (0, 201, 13), (255, 118, 0), (206, 0, 113), (0, 130, 9),
                     (255, 180, 115)),
                    ((191, 159, 64), (183, 182, 208), (4, 31, 183), (167, 184, 45), (122, 128, 212), (37, 204, 7),
                     (88, 155, 213)),
                    ((200, 33, 205), (116, 252, 185), (68, 56, 56), (52, 238, 83), (23, 149, 195), (222, 157, 227),
...
def main():
    ...
    # Load images
    LOGOIMAGE = pygame.image.load('Games/inkspilllogo.png')
    SPOTIMAGE = pygame.image.load('Games/inkspillspot.png')
    SETTINGSIMAGE = pygame.image.load('Games/inkspillsettings.png')
    SETTINGSBUTTONIMAGE = pygame.image.load('Games/inkspillsettingsbutton.png')
    RESETBUTTONIMAGE = pygame.image.load('Games/inkspillresetbutton.png')
...
def checkForQuit():
    ...
    for event in pygame.event.get(KEYUP):  # get all the KEYUP events
        if event.key == K_END or event.key == Constants.ArcadiaBoard.LeftSquareButton:
...
def showSettingsScreen():
    ...
    while True:
        ...
        checkForQuit()
        MOUSE.HandleEvents(pygame.event.get())
        if (not mousex == MOUSE.x) or (not mousey == MOUSE.y):
            mousex, mousey = MOUSE.x, MOUSE.y
            screenNeedsRedraw = True  # screen should be redrawn
        if MOUSE.clicked:
            screenNeedsRedraw = True  # screen should be redrawn
            mousex, mousey = MOUSE.x, MOUSE.y  # syntactic sugar
