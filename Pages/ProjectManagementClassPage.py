...
class ProjectManagementClassPage(Page.Page):
    def __init__(self):
        ...
        self.components = [
            Components.Label.Label([200, 50], 150, "Project", ["red", "black"]),
            Components.Label.Label([150, 170], 150, "Management Class", ["red", "black"]),

            Components.Container.Container(350, 0, 1280, 900, [
                Components.Label.Label([100, 400], 60, "How do we finish a robot in 6 weeks?\n" +
